...
public final class Forward extends AudioPlayerCommand {
    @Override
    public void execute(final AudioPlayer audioPlayer, final CommandInput commandInput,
        ...
        if (currentlyPlaying == null) {
            output.put(Constants.OUTPUT_MESSAGE, Constants.NO_SOURCE_LOADED_FORWARD);
            ...
            output.put(Constants.OUTPUT_MESSAGE, Constants.SUCCESSFUL_FORWARD);
        }
    }
}
